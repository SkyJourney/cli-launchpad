...
#[tauri::command]
pub async fn fetch_latest_versions() -> Result<Vec<LatestVersion>, String> {
...
#[tauri::command]
pub async fn run_install(tool_key: ToolKey, kind: InstallKind) -> Result<InstallOutcome, String> {
